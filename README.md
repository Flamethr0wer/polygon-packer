...
- `--initial_seed`: the initial seed used to generates the seed of each attempt, it has to be an integer between 0 and (2**32 - attempts). Defaults to a random integer.
